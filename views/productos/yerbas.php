...
<head>
  ...
  <link rel="stylesheet" href="yerbas.css">
</head>
<body>
...
<div class="descuentos">
  <div class="descuento">
    <img src="/views/img/yerba.webp" alt="Descuento 1">
    <div class="overlay">20% de Descuento</div>
  </div>
  <div class="descuento">
    <img src="/views/img/yerba.webp" alt="Descuento 2">
    <div class="overlay">30% de Descuento</div>
  </div>
  <div class="descuento">
    <img src="/views/img/yerba.webp" alt="Descuento 3">
...
<h2 id="calabaza">Yerba Sara</h2>
<div class="cards-container" id="calabaza-cards">
  <div class="card">
    <div class="slider">
      <img src="/views/img/sara.jpg" alt="">
      <img src="/views/img/sara.jpg" alt="">
      <img src="/views/img/sara.jpg" alt="">
    </div>
    <h3>Yerba Sara 1</h3>
...
<h2 id="imperial">Yerba Baldo</h2>
<div class="cards-container" id="imperial-cards">
  <div class="card">
    <div class="slider">
      <img src="/views/img/baldo.jpg" alt="">
      <img src="/views/img/baldo.jpg" alt="">
      <img src="/views/img/baldo.jpg" alt="">
    </div>
    <h3>Yerba Baldo 1</h3>
...
<div class="ver-mas-container">
  <button id="btn-ver-mas-imperial">Ver más productos</button>
</div>

<h2 id="torpedo">Yerba Canarias</h2>
<div class="cards-container" id="torpedo-cards">
  <div class="card">
    <div class="slider">
      <img src="/views/img/canarias.jpg" alt="">
      <img src="/views/img/canarias.jpg" alt="">
      <img src="/views/img/canarias.jpg" alt="">
    </div>
...
<div class="ver-mas-container">
  <button id="btn-ver-mas-torpedo">Ver más productos</button>
</div>

<h2 id="camionero">Yerba Amanda</h2>
<div class="cards-container" id="camionero-cards">
  <div class="card">
    <div class="slider">
      <img src="/views/img/amanda.jpg" alt="">
      <img src="/views/img/amanda.jpg" alt="">
      <img src="/views/img/amanda.jpg" alt="">
    </div>
    <h3>Yerba Amanda 1</h3>
    <div class="descripcion" style="display:none;">
    La yerba mate Amanda es una marca argentina de yerba mate producida por la empresa La Cachuera S.A. en Misiones.
  </div>
    <button>Ver más</button>
  </div>
  <div class="card">
...
<div class="ver-mas-container">
  <button id="btn-ver-mas-camionero">Ver más productos</button>
</div>

<h2 id="algarrobo">Yerba Playadito</h2>
<div class="cards-container" id="algarrobo-cards">
  <div class="card">
    <div class="slider">
      <img src="/views/img/playadito.jpg" alt="">
      <img src="/views/img/playadito.jpg" alt="">
      <img src="/views/img/playadito.jpg" alt="">
    </div>
    <h3>Yerba Playadito 1</h3>
    <div class="descripcion" style="display:none;">
    La yerba Playadito es una marca argentina producida por la Cooperativa Agrícola de la Colonia Liebig Ltda., ubicada en Corrientes.
  </div>
    <button>Ver más</button>
  </div>
  <div class="card">
