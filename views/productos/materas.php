...
<head>
  ...
  <link rel="stylesheet" href="materas.css">
</head>
<body>
...
<header>
  ...
  <div class="mobile-nav-container" id="mobile-nav">
    <nav>
      <ul class="nav-list">
        <li><a href="/Mateados/pagprincipal/index.php">Inicio</a></li>
        <li><a href="/Mateados/productos/productos.php">Productos</a></li>
  ...
  <nav class="desktop-nav">
    <ul class="nav-list">
      ...
      <li class="has-submenu">
        ...
        <ul class="submenu">
          <li>
            <a href="/Mateados/productos/mates.php">Mates</a>
            <ul class="submenu-items">
              <li><a href="/Mateados/productos/mates.php">Calabaza</a></li>
              <li><a href="/Mateados/productos/mates.php">Imperial</a></li>
              <li><a href="/Mateados/productos/mates.php">Torpedo</a></li>
              <li><a href="/Mateados/productos/mates.php">Camionero</a></li>
              <li><a href="/Mateados/productos/mates.php">Algarrobo</a></li>
            </ul>
          </li>
          <li>
            <a href="/Mateados/productos/termos.php">Termos</a>
            <ul class="submenu-items">
              <li><a href="/Mateados/productos/termos.php">Metálico</a></li>
            </ul>
          </li>
          <li>
            <a href="/Mateados/productos/yerbas.php">Yerba</a>
            <ul class="submenu-items">
              <li><a href="/Mateados/productos/yerbas.php">Sara</a></li>
              <li><a href="/Mateados/productos/yerbas.php">Baldo</a></li>
              <li><a href="/Mateados/productos/yerbas.php">Canarias</a></li>
              <li><a href="/Mateados/productos/yerbas.php">Amanda</a></li>
              <li><a href="/Mateados/productos/yerbas.php">Playadito</a></li>
            </ul>
          </li>
          <li>
            <a href="/Mateados/productos/materas.php">Materas</a>
            <ul class="submenu-items">
              <li><a href="/Mateados/productos/materas.php">Cuero</a></li>
            </ul>
          </li>
        </ul>
      </li>
...
<section class="galeria">
  <h2 id="calabaza">Materas</h2>
  <div class="cards-container" id="calabaza-cards">
    <div class="card">
      <div class="slider">
        <img src="/views/img/Materas-de-cuero.jpg" alt="">
        <img src="/views/img/Materas-de-cuero.jpg" alt="">
        <img src="/views/img/Materas-de-cuero.jpg" alt="">
      </div>
